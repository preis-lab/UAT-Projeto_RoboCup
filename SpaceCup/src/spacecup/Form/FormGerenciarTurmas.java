...
public class FormGerenciarTurmas extends javax.swing.JInternalFrame {

    private int id;
    private List<Turma> turmas;
    private Usuario usuario;

    public FormGerenciarTurmas(Usuario usuario) {
    ...
    private boolean isAdm() {
        if (usuario.getNivelAcesso() > 0) {
            ...
            cbAnoCompeticao.setEnabled(false);
            cbCompeticao.setEnabled(false);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
       Turma t = new Turma();
        ...
        new TurmaDAO().altera(t);
        JOptionPane.showMessageDialog(this, "Turma " + t.getNome() + " Alterada!");
